...
BP_MEN_GLM_bp_uncontrolled_multiple <- svyglm(bp_uncontrolled_accaha ~ Category + svy_year + demo_age_cat + demo_gender + cc_bmi + cc_diabetes + cc_ckd, design = nhanesDesignSelect, family = binomial)
...
```{r}
model4 <- svyglm(bp_uncontrolled_accaha ~ Category + Antidepressant_Y_N + Category*Antidepressant_Y_N, design = nhanesDesignSelect, family = binomial)
summary(model4)
```
